export default function calPriceShirtAndJacket(Height, userSchool) {
  ...
  switch (userSchool) {
    case "دبستان پسرانه شهاب":
      if (height >= 0 && height <= 58) return 50500;
    ...
    case "دبستان پسرانه صبا":
      if (height >= 0 && height <= 58) return 54000;
    ...
    case "دبستان پسرانه امام حسین":
      if (height >= 0 && height <= 58) return 59500;
    ...
    case "دبستان پسرانه فضیلت":
      if (height >= 0 && height <= 58) return 52000;
    ...
    case "دبستان دخترانه فرهنگ":
      if (height >= 0 && height <= 75) return 52500;
    ...
    case "دبستان دخترانه فضیلت":
      if (height >= 0 && height <= 75) return 53000;
    ...
    case "متوسطه دوره دوم دخترانه رازی":
      if (height >= 0 && height <= 101) return 70000;
